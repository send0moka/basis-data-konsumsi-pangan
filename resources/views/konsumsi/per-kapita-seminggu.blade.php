                                ...
                                <table class="min-w-full">
                                    ...
                                    <tbody class="bg-white divide-y divide-gray-200">
                                        ...
                                        <tr>
                                            ...
                                            <template x-for="(result, index) in results" :key="index">
                                                <td class="px-6 py-4 text-sm text-gray-900 text-center border-l border-gray-200" x-text="(parseFloat(result.konsumsi) * 7 / 1000).toFixed(4)">
                                                </td>
                                            </template>
                                        </tr>
                                        <tr class="bg-gray-50">
                                            ...
                                            <template x-for="(result, index) in results" :key="index">
                                                <td class="px-6 py-4 text-sm text-gray-900 text-center border-l border-gray-200" x-text="formatRupiah(Math.floor(Math.random() * 50000 + 15000))">
                                                </td>
                                            </template>
                                        </tr>
                                        <tr>
                                            ...
                                            <template x-for="(result, index) in results" :key="index">
                                                <td class="px-6 py-4 text-sm text-gray-900 text-center border-l border-gray-200" x-text="(parseInt(result.energi) * 7).toLocaleString('id-ID')">
                                                </td>
                                            </template>
                                        </tr>
                                        <tr class="bg-gray-50">
                                            ...
                                            <template x-for="(result, index) in results" :key="index">
                                                <td class="px-6 py-4 text-sm text-gray-900 text-center border-l border-gray-200" x-text="(parseFloat(result.protein) * 7).toFixed(1)">
                                                </td>
                                            </template>
                                        </tr>
                                    </tbody>
