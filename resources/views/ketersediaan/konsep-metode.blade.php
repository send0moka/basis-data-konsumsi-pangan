            ...
            <div class="grid grid-cols-1 lg:grid-cols-4 gap-8" x-data="konsepMetode()">
                ...
                <div class="lg:col-span-1">
                    <div class="bg-gray-50 rounded-lg p-6 sticky top-24">
                        <h3 class="text-lg font-semibold text-gray-900 mb-6">Daftar Isi</h3>
                        <nav class="space-y-2">
                            <button @click="activeSection = 'pengertian'"
                                    :class="activeSection === 'pengertian' ? 'bg-blue-100 text-blue-700 border-blue-300' : 'text-gray-600 hover:text-gray-900 border-transparent'"
                            ...
                            <button @click="activeSection = 'perhitungan'"
                                    :class="activeSection === 'perhitungan' ? 'bg-blue-100 text-blue-700 border-blue-300' : 'text-gray-600 hover:text-gray-900 border-transparent'"
                                    class="w-full text-left px-3 py-2 rounded-md border text-sm font-medium transition duration-200">
                                Cara Perhitungan
                            </button>
                            <button @click="activeSection = 'komponen'"
                                    :class="activeSection === 'komponen' ? 'bg-blue-100 text-blue-700 border-blue-300' : 'text-gray-600 hover:text-gray-900 border-transparent'"
                                    class="w-full text-left px-3 py-2 rounded-md border text-sm font-medium transition duration-200">
                                Komponen NBM
                            </button>
                            <button @click="activeSection = 'metodologi'"
                                    :class="activeSection === 'metodologi' ? 'bg-blue-100 text-blue-700 border-blue-300' : 'text-gray-600 hover:text-gray-900 border-transparent'"
                                    class="w-full text-left px-3 py-2 rounded-md border text-sm font-medium transition duration-200">
                                Metodologi
                            </button>
                            <button @click="activeSection = 'kegunaan'"
                                    :class="activeSection === 'kegunaan' ? 'bg-blue-100 text-blue-700 border-blue-300' : 'text-gray-600 hover:text-gray-900 border-transparent'"
                                    class="w-full text-left px-3 py-2 rounded-md border text-sm font-medium transition duration-200">
                                Kegunaan & Sumber
                            </button>
                        </nav>
                ...
                <div class="lg:col-span-3">
                    <!-- Pengertian NBM -->
                    <div x-show="activeSection === 'pengertian'" class="bg-white rounded-lg border border-gray-200 p-8">
                        <h2 class="text-2xl font-bold text-gray-900 mb-6">Pengertian Neraca Bahan Makanan (NBM)</h2>
                    ...
                    <!-- Cara Perhitungan -->
                    <div x-show="activeSection === 'perhitungan'" class="bg-white rounded-lg border border-gray-200 p-8">
                        <h2 class="text-2xl font-bold text-gray-900 mb-6">Cara Perhitungan NBM</h2>
                        <div class="prose prose-lg max-w-none">
                            
                            <h3 class="text-xl font-semibold text-gray-800 mb-4">1. Penyediaan (Supply)</h3>
                            ...
                            <h3 class="text-xl font-semibold text-gray-800 mb-4">2. Penggunaan (Utilization)</h3>
                    ...
                    <!-- Komponen NBM -->
                    <div x-show="activeSection === 'komponen'" class="bg-white rounded-lg border border-gray-200 p-8">
                        <h2 class="text-2xl font-bold text-gray-900 mb-6">Komponen Detail NBM</h2>
                        <div class="prose prose-lg max-w-none">
                    ...
                    <!-- Metodologi -->
                    <div x-show="activeSection === 'metodologi'" class="bg-white rounded-lg border border-gray-200 p-8">
                        <h2 class="text-2xl font-bold text-gray-900 mb-6">Metodologi Penyusunan NBM</h2>
                        <div class="prose prose-lg max-w-none">
                            ...
                            <div class="space-y-6">
                                <div class="flex items-start space-x-4">
                                    ...
                                    <div>
                                        <h4 class="font-semibold text-gray-900">Pengumpulan Data</h4>
                                        <p class="text-gray-700">Data diperoleh dari berbagai sumber seperti BPS, Kementerian Pertanian, dan instansi terkait</p>
                                    </div>
                                </div>
                                ...
                                <div class="flex items-start space-x-4">
                                    ...
                                    <div>
                                        <h4 class="font-semibold text-gray-900">Klasifikasi Komoditas</h4>
                                        <p class="text-gray-700">Pengelompokan komoditas berdasarkan jenis dan karakteristiknya</p>
                                    </div>
                                </div>
                                ...
                                <div class="flex items-start space-x-4">
                                    ...
                                    <div>
                                        <h4 class="font-semibold text-gray-900">Konversi Satuan</h4>
                                        <p class="text-gray-700">Penyeragaman satuan ke dalam ton atau kilogram</p>
                                    </div>
                                </div>
                                ...
                                <div class="flex items-start space-x-4">
                                    ...
                                    <div>
                                        <h4 class="font-semibold text-gray-900">Perhitungan Keseimbangan</h4>
                                        <p class="text-gray-700">Aplikasi rumus keseimbangan NBM</p>
                                    </div>
                                </div>
                                ...
                                <div class="flex items-start space-x-4">
                                    ...
                                    <div>
                                        <h4 class="font-semibold text-gray-900">Validasi Data</h4>
                                        <p class="text-gray-700">Pengecekan konsistensi dan kewajaran data</p>
                                    </div>
                                </div>
                            </div>

                            <div class="mt-8 bg-gray-50 p-6 rounded-lg">
                                <h3 class="text-lg font-semibold text-gray-900 mb-4">Periode dan Cakupan</h3>
                                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                    <div class="text-center">
                                        <div class="text-2xl font-bold text-blue-600">Tahunan</div>
                                        <div class="text-sm text-gray-600">Periode Data</div>
                                    </div>
                                    <div class="text-center">
                                        <div class="text-2xl font-bold text-blue-600">34 Provinsi</div>
                                        <div class="text-sm text-gray-600">Cakupan Wilayah</div>
                                    </div>
                                    <div class="text-center">
                                        <div class="text-2xl font-bold text-blue-600">200+ Komoditas</div>
                                        <div class="text-sm text-gray-600">Jenis Pangan</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <!-- Kegunaan dan Sumber -->
                    <div x-show="activeSection === 'kegunaan'" class="bg-white rounded-lg border border-gray-200 p-8">
                        <h2 class="text-2xl font-bold text-gray-900 mb-6">Kegunaan Data NBM</h2>
                        <div class="prose prose-lg max-w-none">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                                <div class="space-y-4">
                                    <div class="flex items-center space-x-3">
                                        ...
                                        <span class="text-gray-700">Perencanaan ketahanan pangan nasional</span>
                                    </div>
                                    <div class="flex items-center space-x-3">
                                        <svg class="w-6 h-6 text-green-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                                        </svg>
                                        <span class="text-gray-700">Monitoring ketersediaan pangan</span>
                                    </div>
                                    <div class="flex items-center space-x-3">
                                        <svg class="w-6 h-6 text-green-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                                        </svg>
                                        <span class="text-gray-700">Evaluasi kebijakan pangan</span>
                                    </div>
                                </div>
                                <div class="space-y-4">
                                    <div class="flex items-center space-x-3">
                                        ...
                                        <span class="text-gray-700">Penelitian dan analisis pangan</span>
                                    </div>
                                    <div class="flex items-center space-x-3">
                                        <svg class="w-6 h-6 text-green-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                                        </svg>
                                        <span class="text-gray-700">Pelaporan internasional (FAO, dll.)</span>
                                    </div>
                                </div>
                            </div>

                            <h3 class="text-xl font-semibold text-gray-900 mb-4">Sumber Data</h3>
