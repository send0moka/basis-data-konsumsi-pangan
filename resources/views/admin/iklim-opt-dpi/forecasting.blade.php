    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        ...
        <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-6 mb-6">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                <div>
                    <label for="parameter" class="block text-sm font-medium text-neutral-700">Parameter</label>
                    <select id="parameter" name="parameter" class="mt-1 block w-full py-2 px-3 border border-neutral-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                        ...
                        <option value="opt">Tingkat Serangan OPT</option>
                    </select>
                </div>
                <div>
                    <label for="periode" class="block text-sm font-medium text-neutral-700">Periode</label>
                    <select id="periode" name="periode" class="mt-1 block w-full py-2 px-3 border border-neutral-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                ...
                <div>
                    <label for="wilayah" class="block text-sm font-medium text-neutral-700">Wilayah</label>
                    <select id="wilayah" name="wilayah" class="mt-1 block w-full py-2 px-3 border border-neutral-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
        ...
        <div class="bg-white dark:bg-zinc-900 overflow-hidden shadow-xl sm:rounded-lg">
            <div class="p-6 border-b border-neutral-200 dark:border-neutral-700">
                <div class="flex justify-between items-center mb-6">
                    <h3 class="text-lg font-medium text-neutral-900 dark:text-neutral-100">Hasil Peramalan</h3>
