    ...
    <div>
        ...
        <div class="mb-6">
            ...
            <p class="mt-1 text-sm text-neutral-600 dark:text-neutral-400">
                Selamat datang di sistem manajemen data lahan
            </p>
        </div>
            ...
            <div class="bg-white dark:!bg-neutral-800 overflow-hidden shadow-lg rounded-lg border border-neutral-200 dark:border-neutral-700">
                <div class="p-4 lg:p-6">
                    <div class="flex items-center">
                        ...
                        <div class="ml-3 lg:ml-4 min-w-0 flex-1">
                            <h3 class="text-base lg:text-lg font-semibold text-neutral-900 dark:text-white truncate">Total Lahan</h3>
                            <p class="text-2xl lg:text-3xl font-bold text-blue-600 dark:text-blue-400">{{ $totalLahan ?? 0 }}</p>
